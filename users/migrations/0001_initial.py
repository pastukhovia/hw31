    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(validators=[users.models.check_age])),
                ('email', models.EmailField(max_length=254, unique=True, validators=[users.models.check_email_if_rambler])),
